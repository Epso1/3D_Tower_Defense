...
namespace Gaskellgames.CameraSystem.EditorOnly
{
    ...
    public class MenuItem_CameraSystem : MenuItemUtility
    {
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Brain", false, CameraSystem_GameObjectMenu_Priority)]
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Rig", false, CameraSystem_GameObjectMenu_Priority + 15)]
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Rig (Free Fly)", false, CameraSystem_GameObjectMenu_Priority + 15)]
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Rig (Freelook)", false, CameraSystem_GameObjectMenu_Priority + 15)]
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Shaker", false, CameraSystem_GameObjectMenu_Priority + 45)]
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Trigger Zone", false, CameraSystem_GameObjectMenu_Priority + 45)]
        ...
        [MenuItem(CameraSystem_GameObjectMenu_Path + "/Camera Trigger Zone (Multi Target)", false, CameraSystem_GameObjectMenu_Priority + 45)]
