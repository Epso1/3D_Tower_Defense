...
namespace Gaskellgames.InputEventSystem.EditorOnly
{
    ...
    [CustomPropertyDrawer(typeof(GMKInputs))]
    public class GMKInputsDrawer : PropertyDrawer
    {
        ...
        {
            return (EditorExtensions.singleLine + EditorExtensions.spacer) * 8;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            float propertyWidth = (position.width - EditorExtensions.spacer) * 0.5f;
            ...
            EditorGUILayout.Space(-(EditorExtensions.singleLine * 3) -(EditorExtensions.spacer * 2));
