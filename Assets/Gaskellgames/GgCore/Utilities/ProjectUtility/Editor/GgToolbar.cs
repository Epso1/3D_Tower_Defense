...
namespace Gaskellgames.EditorOnly
{
    ...
    public class IEditorUpdateCount : EditorToolbarButton
    {
        ...
        {
            text = EditorUpdateLoop.iEditorUpdateList.Count.ToString();
            tooltip = "IEditorUpdate count: Click to refresh.";
            clicked += OnClick;
            
            EditorUpdateLoop.OnIEditorUpdateListUpdated += UpdateText;
        }

        private void OnClick()
        {
            EditorUpdateLoop.ForceUpdateComponentList();
        }
