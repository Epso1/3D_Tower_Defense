...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgCoreSamplesEditorWindow : GGEditorWindow_MenuTree
    {
        ...
        private const string relativePath = "/Utilities/ProjectUtility/Editor/Icons/";
        ...
        [MenuItem(MenuItemUtility.GgCoreSamples_ToolsMenu_Path, false, MenuItemUtility.GgCoreSamples_ToolsMenu_Priority)]
        private static void OpenWindow_ToolsMenu()
        {
            OpenWindow_WindowMenu();
        }

        [MenuItem(MenuItemUtility.GgCoreSamples_WindowMenu_Path, false, MenuItemUtility.GgCoreSamples_WindowMenu_Priority)]
        ...
        protected override void OnInitialise()
        {
            ...
            banner = (Texture)AssetDatabase.LoadAssetAtPath(filePath + "InspectorBanner_GgCore.png", typeof(Texture));
        ...
        {
            string version = isWindowWide ? "Version 1.2.1" : "v1.2.1";
            List<ToolbarItem> leftToolbar = new List<ToolbarItem>
            {
        ...
        protected override MenuTree MenuTree()
        {
            return new MenuTree
            {
                ...
                {
                    new MenuTreePage(Page_AssetsOnly, "AssetsOnly"),
                    new MenuTreePage(Page_Bitfield, "Bitfield"),
                    new MenuTreePage(Page_Button, "Button"),
                    new MenuTreePage(Page_ContainsType, "ContainsType"),
                    new MenuTreePage(Page_CustomCurve, "CustomCurve"),
                    new MenuTreePage(Page_DisableIf, "DisableIf"),
                    new MenuTreePage(Page_DisableInEditMode, "DisableInEditMode"),
                    new MenuTreePage(Page_DisableInPlayMode, "DisableInPlayMode"),
                    new MenuTreePage(Page_EnableIf, "EnableIf"),
                    new MenuTreePage(Page_EnumButtons, "EnumButtons"),
                    new MenuTreePage(Page_FilePath, "FilePath"),
                    new MenuTreePage(Page_FolderPath, "FolderPath"),
                    new MenuTreePage(Page_Graph, "Graph"),
                    new MenuTreePage(Page_GUIColor, "GUIColor"),
                    new MenuTreePage(Page_Hidden, "Hidden"),
                    new MenuTreePage(Page_HideIf, "HideIf"),
                    new MenuTreePage(Page_HideInEditMode, "HideInEditMode"),
                    new MenuTreePage(Page_HideInPlayMode, "HideInPlayMode"),
                    new MenuTreePage(Page_Highlight, "Highlight"),
                    new MenuTreePage(Page_Indent, "Indent"),
                    new MenuTreePage(Page_InfoBox, "InfoBox"),
                    new MenuTreePage(Page_LabelText, "LabelText"),
                    new MenuTreePage(Page_LabelWidth, "LabelWidth"),
                    new MenuTreePage(Page_LineSeparator, "LineSeparator"),
                    new MenuTreePage(Page_Max, "Max"),
                    new MenuTreePage(Page_Min, "Min"),
                    new MenuTreePage(Page_MinMax, "MinMax"),
                    new MenuTreePage(Page_MinMaxSlider, "MinMaxSlider"),
                    new MenuTreePage(Page_OnValueChanged, "OnValueChanged"),
                    new MenuTreePage(Page_ProgressBar, "ProgressBar"),
                    new MenuTreePage(Page_Range, "Range"),
                    new MenuTreePage(Page_ReadOnly, "ReadOnly"),
                    new MenuTreePage(Page_Required, "Required"),
                    new MenuTreePage(Page_ShowAsString, "ShowAsString"),
                    new MenuTreePage(Page_ShowAsTag, "ShowAsTag"),
                    new MenuTreePage(Page_ShowIf, "ShowIf"),
                    new MenuTreePage(Page_StringDropdown, "StringDropdown"),
                    new MenuTreePage(Page_TagDropdown, "TagDropdown"),
                    new MenuTreePage(Page_Title, "Title"),
                    new MenuTreePage(Page_ToggleLeft, "ToggleLeft"),
                    new MenuTreePage(Page_Unit, "Unit"),
                    new MenuTreePage(Page_Wrap, "Wrap"),
                }
            };
        }
        ...
        {
            if (GUILayout.Button("MethodRow1")) { Log("Method 1: Button Pressed"); }
            EditorGUILayout.BeginHorizontal();
            if (GUILayout.Button("MethodRow2a")) { Log("Method 2a: Button Pressed"); }
            if (GUILayout.Button("MethodRow2b")) { Log("Method 2b: Button Pressed"); }
            EditorGUILayout.EndHorizontal();
        }
        
        private void DrawScriptableObjectEditor(Editor scriptableObjectEditor)
        {
            if (scriptableObjectEditor) { scriptableObjectEditor.OnInspectorGUI(true); }
