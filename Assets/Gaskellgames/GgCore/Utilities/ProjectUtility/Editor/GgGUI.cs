...
namespace Gaskellgames.EditorOnly
{
    ...
    public static class GgGUI
    {
        ...
        {
            if (ObjectField(position, label, property.objectReferenceValue, out Object newValue, property.ObjectType(), property.hasMultipleDifferentValues, allowSceneObjects))
            {
