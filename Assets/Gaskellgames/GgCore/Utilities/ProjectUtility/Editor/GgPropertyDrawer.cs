...
namespace Gaskellgames.EditorOnly
{
    ...
    public abstract class GgPropertyDrawer : PropertyDrawer
    {
        ...
        {
            float propertyHeight = PropertyDrawerExtensions.TryFindCustomPropertyDrawer(property, out PropertyDrawer customDrawer)
        ...
        {
            bool hideLabel = string.IsNullOrEmpty(label.text);
            float thisFieldWidth = hideLabel ? position.width : position.width - (labelWidth + standardSpacing);
